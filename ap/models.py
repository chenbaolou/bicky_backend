...
class AP(models.Model):
    ...
    apname = models.CharField(unique=True, max_length=128)
    ...
    group = models.ForeignKey('group.Group', models.CASCADE, db_column='groupIndex')
    ...
    binIndex = models.PositiveIntegerField(db_column='binIndex', blank=True, null=True)
    apType = models.ForeignKey(APType, models.CASCADE, db_column='apType')
